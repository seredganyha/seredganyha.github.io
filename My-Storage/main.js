...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<div *ngFor=\"let item of jsonData; let i = index\"  \n[@changeDivSize]=item.currentState>\n    <mat-card class=\"one\" (click)=\"openDialog(i)\">\n        <mat-card-title>\n          {{item.title}}\n          {{i}}\n        </mat-card-title>\n        \n            <mat-card-content>\n                <!-- <p *ngIf=\"item.currentState=='initial'\">{{item.message}}</p> -->\n                <p>{{item.collection}}</p>\n            \n            </mat-card-content>\n    </mat-card>\n\n            <!-- <mat-card class=\"two\" *ngIf=\"item.currentState=='initial'\">\n              <mat-card-title><h1>Дневник</h1></mat-card-title>\n              <mat-card-content>\n                <mat-card class=\"three\">\n                  <mat-card-title><h4>{{item.title}}</h4></mat-card-title>\n                  <mat-card-content><p>{{item.message}}</p></mat-card-content>\n                  <mat-card-actions class=\"actions\">\n                    <button mat-raised-button color=\"warn\" class=\"bad-btn\">Отрицать</button>\n                    <button mat-raised-button color=\"primary\" class=\"good-btn\">Принять</button>\n                  </mat-card-actions>\n                </mat-card>\n               \n              </mat-card-content>\n            </mat-card>   -->\n\n</div>");
...
/* harmony import */ var _my_main_stage_my_main_stage_component__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./my-main-stage/my-main-stage.component */ "./src/app/my-main-stage/my-main-stage.component.ts");
/* harmony import */ var _menu_item_menu_item_component__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ./menu-item/menu-item.component */ "./src/app/menu-item/menu-item.component.ts");
/* harmony import */ var _menu_them_menu_them_component__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ./menu-them/menu-them.component */ "./src/app/menu-them/menu-them.component.ts");
/* harmony import */ var _content_item_profile_store_profile_store_component__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ./content-item/profile-store/profile-store.component */ "./src/app/content-item/profile-store/profile-store.component.ts");
/* harmony import */ var _content_item_dnevnik_store_dnevnik_store_component__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ./content-item/dnevnik-store/dnevnik-store.component */ "./src/app/content-item/dnevnik-store/dnevnik-store.component.ts");
/* harmony import */ var _capability_uploud_field_uploud_field_component__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! ./capability/uploud-field/uploud-field.component */ "./src/app/capability/uploud-field/uploud-field.component.ts");
...
/* harmony import */ var _content_item_dnevnik_store_dnevnik_read_dnevnik_read_dnevnik_read_component__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(/*! ./content-item/dnevnik-store/dnevnik-read/dnevnik-read/dnevnik-read.component */ "./src/app/content-item/dnevnik-store/dnevnik-read/dnevnik-read/dnevnik-read.component.ts");
/* harmony import */ var _content_item_dnevnik_store_dnevnik_editor_dnevnik_editor_component__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(/*! ./content-item/dnevnik-store/dnevnik-editor/dnevnik-editor.component */ "./src/app/content-item/dnevnik-store/dnevnik-editor/dnevnik-editor.component.ts");
/* harmony import */ var _content_item_organaizer_organaizer_component__WEBPACK_IMPORTED_MODULE_26__ = __webpack_require__(/*! ./content-item/organaizer/organaizer.component */ "./src/app/content-item/organaizer/organaizer.component.ts");
...
AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
        declarations: [
            ...
            _my_main_stage_my_main_stage_component__WEBPACK_IMPORTED_MODULE_17__["MyMainStageComponent"],
            _menu_item_menu_item_component__WEBPACK_IMPORTED_MODULE_18__["MenuItemComponent"],
            _menu_them_menu_them_component__WEBPACK_IMPORTED_MODULE_19__["MenuThemComponent"],
            _content_item_profile_store_profile_store_component__WEBPACK_IMPORTED_MODULE_20__["ProfileStoreComponent"],
            _content_item_dnevnik_store_dnevnik_store_component__WEBPACK_IMPORTED_MODULE_21__["DnevnikStoreComponent"],
            _capability_uploud_field_uploud_field_component__WEBPACK_IMPORTED_MODULE_22__["UploudFieldComponent"],
            _content_item_dnevnik_store_dnevnik_read_dnevnik_read_dnevnik_read_component__WEBPACK_IMPORTED_MODULE_24__["DnevnikReadComponent"],
            _content_item_dnevnik_store_dnevnik_editor_dnevnik_editor_component__WEBPACK_IMPORTED_MODULE_25__["DnevnikEditorComponent"],
            _content_item_organaizer_organaizer_component__WEBPACK_IMPORTED_MODULE_26__["OrganaizerComponent"],
            _content_item_dnevnik_store_dnevnik_read_dnevnik_read_dnevnik_read_component__WEBPACK_IMPORTED_MODULE_24__["DialogOverviewExampleDialog"]
        ],
        entryComponents: [_content_item_dnevnik_store_dnevnik_read_dnevnik_read_dnevnik_read_component__WEBPACK_IMPORTED_MODULE_24__["DialogOverviewExampleDialog"]],
        imports: [
    ...
    openDialog(i) {
        ...
        const dialogRef = this.dialog.open(DialogOverviewExampleDialog, {
            ...
            data: {
                ...
                collectios: this.jsonData[i].message,
            }
        });
...
let JsonCreate = class JsonCreate {
    constructor(http) {
        ...
        this.configDelete = "https://jsonbox.io/box_f9ba3926dade96693495?q=message:**";
    }
    getConfig() {
    ...
    deleteData() {
        return this.http.delete(this.configDelete);
    }
};
