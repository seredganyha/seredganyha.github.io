    ...
    function () {
      ...
      _createClass(CheckListComponent, [{
        ...
        value: function postCheck() {
          ...
          this.js.setDataFirestore('check-list', this.checkForm.value); // this.js.deleteData
          // ().subscribe(val=>{
          //   console.log(val)
          // })
        }
  ...
  function srcAppContentItemProfileStoreProfileStoreComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function () {
      function ProfileStoreComponent(js) {
        ...
        this.click = 0; // this.value.width = this.spinner.width

        this.js.getSelectedDataFirestore('check-list', 'date', moment__WEBPACK_IMPORTED_MODULE_3__().format('DD-MM-YYYY')).subscribe(function (value) {
          if (value[0].aliases) {}

          _this5.jsonData = value[0].aliases;

          if (!_this5.jsonData) {
            console.log(_this5.jsonData);
            _this5.nullTasks = false;
          } else {
            _this5.nullTasks = true;
          }
        });
      }
